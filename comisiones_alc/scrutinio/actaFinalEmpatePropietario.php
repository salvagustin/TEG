...
$depa =$jornada["id_depa"] ;
$muni = $jornada["id_muni"];
$cont = $con->consulta( "SELECT COUNT(id_votacion) AS total FROM votacion WHERE id_jornada = '$id' AND eliminado = 0 AND id_depto = $depa AND id_muni = $muni" );
...
<div class="row">
  ...
  <div class="col text-center">
    ...
    <h2>ACTA DE ESCRUTINIO FINAL DE ELECCIÓN DE MIEMBROS PROPIETARIO Y SUPLENTE EN REPRESENTACIÓN DE LOS SERVIDORES PUBLICOS DE <?php echo mb_strtoupper($parametro["municipio"],'utf-8'); ?>, ANTE LA COMISIÓN DE ÉTICA GUBERNAMENTAL.</h2>
  </div>
  <div class="col-2 text-center"> <img src="../plantilla/dist/img/Escudo.fw.png" width="81" height="91"> </div>
</div>
<div class="row">
  <div class="col">
    <p class="text-justify" style="font-size:24px">En las instalaciones de la Alcaldia Municipal de  <?php echo $parametro["municipalidad"]; ?>, departamento de <?php echo $parametro["depto"]; ?>. a las <?php echo strtolower(@$V->ValorEnLetras(date("H", strtotime($jornada["horaHasta"])), '')); ?> horas
      ...
      con el cargo de <?php echo $candidatos["cargoMuni"]; ?>, del domicilio de <?php echo $candidatos["domicilio"]; ?>, de nacionalidad salvadoreña, con Documento Único de Identidad número
      <?php
