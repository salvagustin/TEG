...
$dui=$_POST["dui"];
    ...
    $bus = $con->arreglo($bu);
        ...
        echo "<script> 
            window.location.href='preguntaSeguro.php?id=$id';
             </script>";      
      }
            ...
            <div class="card border-primary">
              ...
              <div class="card-body">
                <div class="form-group">
                  <label for="">DUI</label>
                  <input type="text" name="dui" id="dui" class="form-control" placeholder="00000000-0" autocomplete="off" data-inputmask='"mask": "99999999-9"' data-mask required>* Datos obiligatorios
                </div>
              </div>
