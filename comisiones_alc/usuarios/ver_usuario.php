  ...
  <div class="card-body">
    <table id="usuarios" class="table table-bordered table-striped">
      ...
      <tbody>
        ...
        $sql = $con->consulta("SELECT * FROM adm_usuarios INNER JOIN adm_rol ON adm_usuarios.rol = adm_rol.rol AND adm_usuarios.rol = adm_rol.rol  ");
        ...
        ?>
          <tr>
            ...
            <td>
              ...
              <?php if ($_SESSION["rol"] == "Super") {  ?> <button class="btn btn-danger" onclick="preguntarSiNo('<?php echo $ver['id']; ?>')"><i class="fas fa-user-times"></i> </button> <?php } ?>
            </td>
          </tr>
        <?php } ?>
      </tbody>
