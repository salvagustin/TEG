...
<head>
    ...
    <script src="jornadas/funciones.js"></script>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            ...
                            <h1 class="m-0 text-dark">Jornadas electorales</h1>
            ...
            <section class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="nuevo">
                        ...
                        <?php include("jornadas/agregarJornada.php"); ?>
                    ...
                    <div class="row">
                        ...
                        <?php include("jornadas/editarJornada.php"); ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#guardarnuevo').click(function() {
                ...
                agregardatos(descripcion, fecha, desde, hasta,Jdesde,Jhasta,deptoExpe,muniExpe);
